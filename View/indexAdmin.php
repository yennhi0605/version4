...
if (isset($_POST["add"])) {
  ...
  $sql = "INSERT INTO milktea() VALUES(null,'" . $name . "','" . $price . "','" . $type . "','Image/" . $image . "')";
  $db->query($sql);
    ...
    ?>
      <div class="item-milk">
        ...
        <form action="edit.php" method="post" class="btn">
          <button type="submit" name="edit" style=" background-color: sandybrown" value="<?php echo $milkteas[$i]->id; ?>">Edit
          </button>
        </form>
        <form method="post">
